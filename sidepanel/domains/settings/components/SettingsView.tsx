...
export function SettingsView({ settings, projects, onSettingsChange, onTestConnection, onUrlBlur, onRedmineApiKeyBlur, onGitlabUrlBlur, onGitlabTokenBlur, onExportSettings, onImportSettings, connectionStatus, saveStatus, validationErrors }: SettingsViewProps) {
